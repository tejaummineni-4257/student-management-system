...
const API = axios.create({
  baseURL: "https://student-management-system-4tzp.onrender.com/api",
});
...
export const adminAPI = {
  ...
  verifyAchievement: (id, data) =>
    API.put(`/admin/achievement/${id}/verify`, data),
...
// AI APIs
export const aiAPI = {
  generateSummary: (achievementId) =>
    API.post("/ai/achievement-summary", { achievementId }),
